...
let options = { maxAge: '2y' }                  // The cache data leeftijd before auto deleting
app.use(express.static("public",options));      // Configureer de app om statische bestanden te kunnen serveren vanuit de 'public' map
